...
Rails.application.configure do
  ...
  config.assets.quiet = true if defined?(Rails.application.config.assets)
  ...
  # Bullet gem for N+1 query detection (if added to Gemfile)
  if defined?(Bullet)
  ...
  # Less verbose logging of parameters
