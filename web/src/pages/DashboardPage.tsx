    ...
    <div>
      ...
      {widgets.filter(w => w.visible).map(widget => {
        switch (widget.id) {
          case 'summary-cards':
            return (
              <div key="summary-cards" className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4 mb-8">
          ...
          case 'spending-chart':
            return (
              <div key="spending-chart" className="mb-8">
                <Card 
          ...
          case 'account-balances':
            return (
              <div key="account-balances" className="mb-8">
                <Card 
          ...
          case 'budget':
            return <div key="budget" className="mb-8"><DashboardBudgetWidget /></div>;

          case 'bills':
            return <div key="bills" className="mb-8"><DashboardBillsWidget /></div>;

          case 'goals':
            return <div key="goals" className="mb-8"><DashboardGoalsWidget /></div>;

          case 'investments':
            return <div key="investments" className="mb-8"><DashboardInvestmentsWidget /></div>;

          case 'recent-transactions':
            return (
              <div key="recent-transactions" className="mb-8">
                <Card 
