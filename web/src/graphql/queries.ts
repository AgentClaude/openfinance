...
export const GET_REPORTS = gql`
  query GetReports($months: Int, $dateFrom: String, $dateTo: String, $accountIds: [ID!], $excludeTransfers: Boolean) {
    reports(months: $months, dateFrom: $dateFrom, dateTo: $dateTo, accountIds: $accountIds, excludeTransfers: $excludeTransfers) {
      monthlySummary {
        month
        income
        expenses
