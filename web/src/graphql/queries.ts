...
export const GET_REPORTS = gql`
  query GetReports($months: Int, $dateFrom: String, $dateTo: String, $accountIds: [ID!], $categoryIds: [ID!]) {
    reports(months: $months, dateFrom: $dateFrom, dateTo: $dateTo, accountIds: $accountIds, categoryIds: $categoryIds) {
      monthlySummary {
        month
        income
        expenses
